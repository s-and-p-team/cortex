...
2. Update **Mermaid workflow diagrams** for root flows:
   ...
   - Orchestrate workflow (orchestrate:scan → orchestrate:plan → phases → orchestrate:review)
   - Any repo-specific workflows discovered during the scan
...
- `orchestrate` - Orchestrate related repositories
